# Makers Weekly Collector v1.2.4

The Makers collector now uses the same hardened Yahoo parsing/validation engine as the accepted Mis.Exp v1.2.4 collector, while remaining isolated to The Makers.
...
The collector now gathers and validates:
...
- structured transactions with adds, drops, waiver/FAAB information and duplicate Yahoo wrapper rows compacted
...
- `Makers_Weekly_Collector_v1.2.4.txt` — identical versioned copy
